...
public class CycleLayerDownAction extends JosmAction {
    ...
    protected final static int KEYDOWN = KeyEvent.VK_CLOSE_BRACKET;
    protected final static int MODIFIER = Shortcut.SHIFT;
    private static Shortcut cycleDown = Shortcut.registerShortcut("core:cyclelayerdown", tr("Cycle layers down"),
            KEYDOWN, MODIFIER);
